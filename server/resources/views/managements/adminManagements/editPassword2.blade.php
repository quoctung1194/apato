...
@section('content')
<h1 class="page-header">@lang('main.change_password_2')</h1>
<script src="{{ URL::asset('js/management/adminManagement/editPassword.js?v=' . CommonConstant::RESOURCE_VERSION) }}"></script>

<input type="hidden" id="current_route" value="{{URL::route('MA-005')}}" />

<div class="table-responsive">
	<form id="editForm" method="POST" action="{{ route('MA-006') }}" onsubmit="return false">
		{{ method_field('PUT') }}
		{{ csrf_field() }}
